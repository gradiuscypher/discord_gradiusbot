...
def action(message, client, config):
    ...
    try:
        ...
        try:
            ...
            error_message = "Problem executing ss_optional_groups function. Failed to get the target user."
        ...
        if target_user is not None:
            ...
            yield from client.send_message(message.author, "Please let @gradius know about that the bad bug occurred. "
                                                           "Try messaging again later.")
